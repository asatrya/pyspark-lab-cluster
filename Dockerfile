...
RUN wget -P /tmp/ https://downloads.apache.org/spark/spark-3.1.1/spark-3.1.1-bin-hadoop2.7.tgz
RUN tar xvf /tmp/spark-3.1.1-bin-hadoop2.7.tgz -C /tmp && \
    mv /tmp/spark-3.1.1-bin-hadoop2.7 ${SPARK_HOME}
